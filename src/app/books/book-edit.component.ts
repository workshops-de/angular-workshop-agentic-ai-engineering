        ...
        <form [formGroup]="bookForm" (ngSubmit)="onSubmit()" class="space-y-6">
          <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="mb-6">
              ...
              <div
                *ngIf="bookForm.get('isbn')?.invalid && bookForm.get('isbn')?.touched"
                class="mt-1 text-sm text-red-600"
              >
                <div *ngIf="bookForm.get('isbn')?.errors?.['pattern']">Please enter a valid ISBN format.</div>
              </div>
            </div>
            ...
            <div class="mb-6">
              ...
              />
              <div
                *ngIf="bookForm.get('publisher')?.invalid && bookForm.get('publisher')?.touched"
                class="mt-1 text-sm text-red-600"
              >
            ...
            <div class="mb-6">
              ...
              />
              <div
                *ngIf="bookForm.get('numPages')?.invalid && bookForm.get('numPages')?.touched"
                class="mt-1 text-sm text-red-600"
              >
                <div *ngIf="bookForm.get('numPages')?.errors?.['required']">Number of pages is required.</div>
                <div *ngIf="bookForm.get('numPages')?.errors?.['min']">Number of pages must be at least 1.</div>
              </div>
            </div>
            ...
            <div class="mb-6">
              ...
              >
                ...
                <div *ngIf="bookForm.get('price')?.errors?.['pattern']">
                  Please enter a valid price format (e.g., $29.99).
                </div>
              </div>
            </div>
            ...
            <div class="mb-6">
              ...
              ></textarea>
              <div
                *ngIf="bookForm.get('abstract')?.invalid && bookForm.get('abstract')?.touched"
                class="mt-1 text-sm text-red-600"
              >
                <div *ngIf="bookForm.get('abstract')?.errors?.['maxlength']">
                  Abstract cannot exceed 2000 characters.
                </div>
              </div>
            </div>
          </div>
